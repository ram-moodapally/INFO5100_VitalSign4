...
public class ManageVitalSignsJPanel extends javax.swing.JPanel {
    ...
    private void populatePatientsTable(ArrayList<Person> personList) {
        ...
        {
            JOptionPane.showMessageDialog(this, "No Persons Details found. Please add Persons in Manage Person ",
    ...
    private void populateVitalSignTable(Person person) {
        ...
        if (person != null) {
            ...
            if (vitalSignList.isEmpty()) {
                JOptionPane.showMessageDialog(this, "No vital signs has been found", "Error", JOptionPane.INFORMATION_MESSAGE);
                return;
            }
    ...
    private void initComponents() {
        ...
        viewPatientsJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient Name", "Age", "Patient ID", "Community", "SSN "
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(refreshVitalSignsJButton, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(206, 206, 206))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(addVitalSignsJButton, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(displayDetailsJButton, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
